        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            bool checkMemberExists()
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT * from login where USER_ID='" + TextBox2.Text.Trim() + "';", con);
            ...
            void signUpNewMember()
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO login(FULL_NAME,USER_ID,CONTACT_NUM,EAMIL,STATE,CITY,PINCODE,PASSWORD,CONFIRM_PASSWORD,ACC_STATUS) values(@FULL_NAME,@USER_ID,@CONTACT_NUM,@EAMIL,@STATE,@CITY,@PINCODE,@PASSWORD,@CONFIRM_PASSWORD,@ACC_STATUS)", con);
